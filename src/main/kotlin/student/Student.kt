...
class Student: SuperStudentClass {
    @field:JsonProperty("lastName") var lastName: String = ""
        set(value)
        {
            if(SuperStudentClass.validateLastName(value))
            {
                field=value
            }
        }
    ...
    @field:JsonProperty("firstName") var firstName: String = ""
        set(value)
        {
            if(SuperStudentClass.validateFirstName(value))
            {
                field=value
            }
        }
    ...
    @field:JsonProperty("phone") var phone: String? = null
        set(value)
        {
            if(SuperStudentClass.validatePhone(value)) {
                field = value
            }
        }
        get()
    ...
    @field:JsonProperty("telegram") var telegram: String? = null
        set(value)
        {
            if(SuperStudentClass.validateTG(value)) {
                field = value
            }
        }
        get()
    ...
    @field:JsonProperty("email") var email: String? = null
        set(value)
        {
            if(SuperStudentClass.validateEMail(value)) {
                field = value
            }
        }
        get()
    ...
    {
        if(_phone!=null&& SuperStudentClass.validatePhone(_phone))
        {
            phone = _phone
        }
        if(_telegram!=null&& SuperStudentClass.validateTG(_telegram))
        {
            telegram = _telegram
        }
        if(_mail!=null&& SuperStudentClass.validateEMail(_mail))
        {
            email = _mail
        }
    }
